        ...
        <div className="flex flex-col gap-24 pb-24 overflow-hidden">
            ...
            <section className="relative pt-20 pb-32 px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-md border border-white/40 shadow-sm mb-8 animate-fade-in-up hover:scale-105 transition-transform cursor-default">
                        <span className="relative flex h-2.5 w-2.5">
                          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-brand-400 opacity-75"></span>
                          <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-brand-500"></span>
                        </span>
                        <span className="text-sm font-semibold text-slate-700 tracking-wide">Novas turmas abertas para 2024</span>
                    </div>
                    
                    <h1 className="text-6xl md:text-8xl font-display font-bold text-slate-900 tracking-tight mb-8 leading-[1.05] animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                        O futuro da sua <br/>
                    ...
                    <p className="text-xl md:text-2xl text-slate-600 mb-12 max-w-3xl mx-auto leading-relaxed font-light animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                        <Link to="/cursos" className="w-full sm:w-auto px-10 py-5 bg-slate-900 text-white rounded-full font-bold text-lg hover:bg-slate-800 hover:-translate-y-1 transition-all shadow-[0_20px_50px_rgba(15,23,42,0.3)] flex items-center justify-center gap-3 group">
                            Explorar Cursos 
                            <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
                        </Link>
                        <Link to="/video-aula" className="w-full sm:w-auto px-10 py-5 bg-white/80 backdrop-blur-sm text-slate-800 border border-white/50 rounded-full font-bold text-lg hover:bg-white hover:border-brand-200 hover:-translate-y-1 transition-all shadow-lg shadow-slate-200/50 flex items-center justify-center gap-3">
                    ...
                    <div className="mt-16 flex items-center justify-center gap-8 opacity-70 grayscale hover:grayscale-0 transition-all duration-500 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                        <div className="flex -space-x-4">
                            ...
                            <div className="w-12 h-12 rounded-full border-4 border-white bg-slate-100 flex items-center justify-center text-xs font-bold text-slate-600 shadow-md">+2k</div>
                        </div>
                        <div className="text-left">
                            <div className="flex text-yellow-400 text-sm">★★★★★</div>
                            <p className="text-sm font-medium text-slate-500">Aprovado por alunos</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full -mt-12 relative z-20">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    {[
                        ...
                        <div key={idx} className="group bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/40 hover:-translate-y-2 transition-all duration-300 text-center">
                            <div className={`w-14 h-14 mx-auto mb-4 rounded-2xl ${stat.bg} ${stat.color} flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform`}>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    <div>
                        <div className="inline-block px-4 py-1.5 rounded-full bg-brand-50 text-brand-700 font-bold text-sm mb-6">
                            Nossa Metodologia
                        </div>
                        <h2 className="text-4xl md:text-5xl font-display font-bold text-slate-900 mb-6 leading-tight">
                            Por que somos a escolha de <span className="bg-brand-100 text-brand-800 px-2 rounded-lg -rotate-1 inline-block">milhares</span>?
                        </h2>
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={idx} className="flex gap-5 items-start">
                                    <div className="w-12 h-12 rounded-2xl bg-white shadow-lg shadow-slate-100 flex items-center justify-center text-brand-600 shrink-0 border border-slate-100">
                    ...
                    <div className="relative">
                        ...
                        <img 
                            ...
                            alt="Students" 
                            className="relative rounded-[2rem] shadow-2xl border-4 border-white object-cover h-[600px] w-full"
                        />
                        
                        {/* Floating Card */}
                        <div className="absolute -bottom-8 -left-8 bg-white p-6 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] max-w-xs animate-bounce" style={{ animationDuration: '3s' }}>
                            <div className="flex items-center gap-3 mb-3">
                                <div className="p-2 bg-green-100 text-green-600 rounded-lg"><CheckCircle2 size={20} /></div>
                                <span className="font-bold text-slate-900">Curso Concluído!</span>
                            </div>
                            <p className="text-sm text-slate-500">Parabéns! Você finalizou "React Avançado" com 98% de aproveitamento.</p>
                        </div>
                    </div>
                </div>
            </section>
             ...
             <section className="bg-white py-24 border-y border-slate-100 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-gradient-to-b from-brand-50 to-transparent rounded-full blur-3xl -z-0 translate-x-1/2 -translate-y-1/2"></div>
                
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-4xl font-display font-bold text-slate-900 mb-6">O que dizem nossos alunos</h2>
                        <p className="text-lg text-slate-500">Histórias reais de quem transformou a carreira com a InfoTec.</p>
                    </div>
